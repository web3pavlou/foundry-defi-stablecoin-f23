...
* @notice Mock version of a Decentralized Stablecoin used to simulate failure modes,taken by Patrick Collins
 */
contract MockMoreDebtDSC is ERC20Burnable, Ownable {
    ...
    as a parameter.
    For example:
    constructor() ERC20("DWebThreePavlouSC", "DWTPSC") Ownable(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266) {}
